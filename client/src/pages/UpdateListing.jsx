        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                ' id='name' maxLength='62' minLength='10' required onChange={handleChange} value={formData.name} />
                    <textarea
                        onChange={handleChange} value={formData.description} type="text" placeholder='Description' className='border p-3 rounded-lg
                ...
                ' id='address' required />
                    <div className='flex gap-6 flex-wrap'>
                        ...
                        <div onChange={handleChange} checked={formData.offer} className='flex  gap-2'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        ...
                        <div className='flex items-center gap-2'>
                            <input onChange={handleChange} value={formData.regularPrice} className='p-3 border-gray-300 rounded-lg' type="number" id='regularPrice' min='4000' max='10000000' required />
                        ...
                        {formData.offer && (
                            <div className='flex items-center gap-2'>
                                <input onChange={handleChange} value={formData.discountPrice} className='p-3 border-gray-300 rounded-lg' type="number" id='discountPrice' min='0' max='10000000' required />
                                <div className='flex flex-col items-center'>
                ...
                hover:opacity-90 disabled:opacity-80'>{loading ? 'Creating...' : "Update Listing"}</button>
